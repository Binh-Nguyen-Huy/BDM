...
{
    $new_product[$index][0] = $product[$index]['name'];
    $new_product[$index][1] = $product[$index]['price'];
    $new_product[$index][2] = $product[$index]['created_time'];
        ...
        <a href="store.php?id=<?php echo $_GET['id'];?>">
            ...
            <ul class="nav__list">
                    ...
                    <li>
                        ...
                        <div class="nav__drop-content">
                            ...
                            <?php
                                echo "<a href=\"nike_browse-by-time.php?id=$id\">Browse Products by Created Time</a>";
                            ?>
                        </div>
                    </li>
                    <li>
            ...
            <nav class="nav__responsive">
                <ul class="nav__responsive-list">
                    ...
                    <li>
                    <?php
                            echo "<a href=\"nike_browse-by-time.php?id=$id\" class='nav_responsive-link'>Browse Products by Created Time</a>";
                        ?>
                    </li>
                    <li>
        ...
        <div class="grid">
            ...
            <div class="col p-12 t-12 m-12 drop-down">
                <?php
                    ...
                    {
                        echo "<h1> Browse by ".$name."<br>";
                    }

                    if($name == 'NEWEST FIRST')
                    {
                        echo "<h1> Browse by ".$name."<br>";
                    }
                ?>
            ...
            <div class="row products">
                <?php
                    if($name == 'OLDEST FIRST'){
                            ...
                            $try = $page;
                            for($i = $try - 1; $i < $try + 1; $i++)
                            {

                                if($i == $count_product)
                                {
                                    echo "<div class='col p-6 t-12 m-12'><div class='product'><a href='lv_product-detail.html'></a></div></div>";
                                    break;
                                }
                                echo "<div class='col p-6 t-12 m-12'><div class='product'><a href=\"product-detail.php?id=$new_id[$i]\">";
                                echo "<h3>".$new_product[$i][3]. "</h3><br>";
                                echo "<pre>";
                                echo "<h3>".$new_product[$i][0]. "</h3><br>";
                                echo "<pre>";
                                echo "<h3>price: " .$new_product[$i][1]. "</h3>";
                                echo "<pre>";
                                echo "<h3>created time: " .$new_product[$i][2]. "</h3>";
                                echo "<pre>";
                                echo "<h3>description: " .$new_product[$i][4]. "</h3><br>";
                                echo "</a></div></div>";
                            }
                            ...
                            if($page < $count_product + 1)
                            {
                                echo "<div class='col p-6 t-12 m-12'>";
                                echo "<h1><a href=\"?page=$page&name=$name&id=$id\">Next</a></h1>";
                                echo "</div>";
                            }
                            ...
                            {
                                echo "<div class='col p-6 t-12 m-12'>";
                                echo "<h1><a href=\"?page=".($page - 4)."&name=$name&id=$id\">Previous</a></h1>";
                                echo "</div>";
                    ...
                    if($name == 'NEWEST FIRST')
                    {
                        $try_2 = $count_product - $page;
                        for($i = $try_2; $i > $try_2 - 2; $i--)
                        {
                            if($i < 0)
                            {
                                echo "<div class='col p-6 t-12 m-12'><div class='product'><a href='lv_product-detail.html'></a></div></div>";
